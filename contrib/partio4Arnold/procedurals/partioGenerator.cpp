        ...
        else
        {
            ...
            else if ( points->attributeInfo("radiusPP",radiusAttr) || points->attributeInfo("radius",radiusAttr))
         {
            ...
            else
            {
               ...
               //}
               AiArraySetRGB(rgbArr,i, arg_defaultColor);
            }
            /// opacityPP
            if (hasOpacPP)
            {
            ...
            else
            {
               ...
               //{
                  ...
                  else
                  {
                     ...
                     AiArraySetFlt(opacityArr, i , arg_defaultOpac);
                  }
               //}
            }
            ...
            else
            {
               ...
               //{
                  if (badParticle)
                  {
                     ...
                     AiArraySetFlt(radarr, i, 0.0f);
                  }
                  else
                  {
                     //AiArraySetFlt(radarr, ((s*pointCount)+i), arg_radius*arg_radiusMult);
                     AiArraySetFlt(radarr, i, arg_radius*arg_radiusMult);
                  }
               //}
            }
            }
